  ...
  <div id="map" class="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat">
    <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31726.26301308719!2d106.79234584848513!3d-6.292241839070689!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f1f971a243d7%3A0x3333431af7020c60!2sCilandak%20Tim.%2C%20Ps.%20Minggu%2C%20Kota%20Jakarta%20Selatan%2C%20Daerah%20Khusus%20Ibukota%20Jakarta!5e0!3m2!1sid!2sid!4v1714737390733!5m2!1sid!2sid"
      width="100%" height="480" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
  </div>
  <div class="container px-6 md:px-12" data-aos="flip-down">
    <div
        ...
        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
          ...
          @csrf
            <div class="relative mb-6" data-te-input-wrapper-init>
              <input type="text"
                  class="@error('name') is-invalid @enderror text-black peer block min-h-[auto] w-full rounded border-gray-400 border-2 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none "
                  name="name"
                  required
              />
              <label
            ...
            <div class="relative mb-6" data-te-input-wrapper-init>
              <input type="email"
                  class="@error('email') is-invalid @enderror text-black peer block min-h-[auto] w-full rounded border-gray-400 border-2 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none "
                  name="email"
                  required
              />
              <label
            ...
            <div class="relative mb-6" data-te-input-wrapper-init>
              <textarea
                  class="@error('message') is-invalid @enderror text-black peer block min-h-[auto] w-full rounded border-gray-400 border-2 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none "
            ...
            @if (session('message'))
              <p class="text-green-500 mb-3">Success sending!</p>
            @endif
            <button type="submit"
                class="mb-6 w-full rounded bg-accent text-white px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal   lg:mb-0">
                Send
            </button>
          </form>
        </div>
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12 text-black">
          <div class="flex flex-wrap">
